...
export default class Carousel {
    constructor(obj) {
        ...
        this.imgs = this.imgs.substring(1,this.imgs.length-1).split(",");

        this.contianer = (typeof this.contianer =="string") ?document.querySelector(this.contianer):this.contianer;
    ...
    render() {
        ...
        this.box.className="carousel-box";
        ...
        this.contianer.appendChild(this.box);

    }

    // 动态添加样式
    setStyle(){
        Uitls.setStyle(cssStr,"Carousel");
    }
